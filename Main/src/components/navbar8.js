        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          ...
          <div className="navbar8-buttons">
            <button className="navbar8-action1 thq-button-filled thq-button-animated">
              <span className="thq-body-small">Download</span>
            </button>
...
Navbar8.defaultProps = {
  page4ImageSrc:
    'https://images.unsplash.com/photo-1674981622711-ed1e476114da?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMDYyNzE5NXw&ixlib=rb-4.0.3&q=80&w=1080',
  page3: 'Guides',
  logoAlt: 'Site Logo',
  link2: '/downloads',
  page1ImageAlt: 'Home Image',
  page3ImageAlt: 'Guides Image',
  page3Description: 'Find guides for all your needs!',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1641502929363-17824daa84e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMDYyNzE5Nnw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: 'Login',
  link4: '/contact',
  page4ImageAlt: 'Contact Image',
  link3: '/guides',
  action2: 'Sign Up',
  page1Description: 'Welcome to our site!',
  page2Description: 'Get all the stuff you need!',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1578725140697-42be04cbacd5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMDYyNzE5NXw&ixlib=rb-4.0.3&q=80&w=1080',
  page4Description: 'Reach out to us for any inquiries.',
  page4: 'Contact',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page2: 'Downloads',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1643877325038-f9a19083f6eb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyMDYyNzE5NXw&ixlib=rb-4.0.3&q=80&w=1080',
  page2ImageAlt: 'Downloads Image',
  link1: '/home',
  page1: 'Home',
}
