        ...
        <div className="steps2-container1 thq-grid-2">
          <div className="steps2-section-header">
            ...
            <p className="thq-body-large">
              Always good and avaible. Easy and fast to use. Upload your own Apps.
            </p>
...
Steps2.defaultProps = {
  step4Description:
    'Enjoy your downloaded content and make the most out of our resources.',
  step1Description: 'Explore our wide range of downloadable content.',
  step2Description:
    'Select the items you want and start downloading them instantly.',
  step4Title: 'Enjoy',
  step3Description: 'Access helpful guides and tutorials for all your needs.',
  step1Title: 'Browse',
  step2Title: 'Download',
  step3Title: 'Guides',
}
